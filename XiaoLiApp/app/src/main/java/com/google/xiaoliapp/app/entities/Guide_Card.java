package com.google.xiaoliapp.app.entities;
...
public class Guide_Card {
    ...
    public Guide_Card(int card_image, String card_limit, String card_rule, String card_title, String date) {
