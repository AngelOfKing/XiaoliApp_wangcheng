...
import com.xiaoliapp.app.entity.Guide_Card;
...
public class MycardAdapter extends BaseAdapter {
    ...
    public MycardAdapter(List<Guide_Card> cards, Context context) {
        this.cards = cards;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        /////////////////////// 设置数据
        Guide_Card card = cards.get(position);
