...
import com.xiaoliapp.app.adapter.Topic_CareAdapter;
import com.xiaoliapp.app.entity.Guide_TopicCare;
...
public class TopicCareActivity extends ActionBarActivity implements AdapterView.OnItemSelectedListener, AdapterView.OnItemClickListener {
    ...
    private List<Guide_TopicCare> list;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        list = new ArrayList<Guide_TopicCare>();
        if(list!=null){
            for (int i = 0; i < 3; i++) {
                Guide_TopicCare care = new Guide_TopicCare();
